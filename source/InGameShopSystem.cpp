...
CInGameShopSystem::CInGameShopSystem()
{
	...
	m_bIsShopOpenLock = true;	// 샵잠그기 : default
	m_bIsBanner	= false;
...
//-----------------------------------------------------------------------------
	...
	if(!res.IsSuccess())
	{
		...
		// "스크립트 다운로드 실패!##게임을 재접속 해주시기 바랍니다#Version %d.%d.%d#%s"
