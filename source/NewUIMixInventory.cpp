...
int CNewUIMixInventory::FindEmptySlot(ITEM* pItemObj)
{
	if (pItemObj == NULL)
		return -1;
...
bool CNewUIMixInventory::InventoryProcess()
{
	...
	{
		g_pStorageInventory->ProcessStorageItemAutoMove2();
		return true;
	}
	return false;
}

void CNewUIMixInventory::ProcessMixItemAutoMoveSuccess()
{
	if (!IsVisible())
		return;
...
void CNewUIMixInventory::SetItemAutoMove(bool bItemAutoMove)
{
