...
{
	// ----
	g_ErrorReport.Write( "g_lpDSBuffer: %d\r\n", sizeof(g_lpDSBuffer));
	g_ErrorReport.Write( "g_lpDS3DBuffer: %d\r\n", sizeof(g_lpDS3DBuffer));
	g_ErrorReport.Write( "*Object3DSound1: %d\r\n", sizeof(*Object3DSound));
	g_ErrorReport.Write( "*Object3DSound2: %d\r\n", sizeof(Object3DSound));
	g_ErrorReport.Write( "g_lpPropertySet: %d\r\n", sizeof(g_lpPropertySet));
	g_ErrorReport.Write( "---------\r\n");
	g_ErrorReport.Write( "LPDIRECTSOUNDBUFFER: %d\r\n", sizeof(LPDIRECTSOUNDBUFFER));
	g_ErrorReport.Write( "LPDIRECTSOUND3DBUFFER: %d\r\n", sizeof(LPDIRECTSOUND3DBUFFER));
	g_ErrorReport.Write( "OBJECT: %d\r\n", sizeof(OBJECT));
	g_ErrorReport.Write( "LPKSPROPERTYSET: %d\r\n", sizeof(LPKSPROPERTYSET));
	// ----
    HRESULT             hr;
