...
//-----------------------------------------------------------------------------
	...
	DWORD g_dwCharSet[NUM_LANGUAGE] = { DEFAULT_CHARSET, DEFAULT_CHARSET, DEFAULT_CHARSET, DEFAULT_CHARSET, /**/DEFAULT_CHARSET/**/, DEFAULT_CHARSET, DEFAULT_CHARSET, DEFAULT_CHARSET};
	int iLengthAuthorityCode[NUM_LANGUAGE] =
	{
		7,	// 한국
#ifdef LDK_MOD_PASSWORD_LENGTH_20
